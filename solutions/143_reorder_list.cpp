 ...
 * Идея решения: Найти середину, перевернуть вторую половину, слить.
 * 
...
void test_143() {
    ...
    cout << "\nОписание: Переупорядочить список: L0 → Ln → L1 → Ln-1 → ..." << endl;
    cout << "\nИдея: Найти середину, перевернуть вторую половину, слить." << endl;
